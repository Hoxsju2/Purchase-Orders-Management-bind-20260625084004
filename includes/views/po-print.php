...
<head>
    ...
    <style>
        ...
        .po-container { max-width: 100%; margin: 0 auto; background: #fff; padding: 30px; border-radius: 8px; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1); }
        ...
        @media print {
            ...
            .po-container { box-shadow: none; padding: 0; max-width: 100%; border: none; }
    ...
    <div class="po-container" id="po-content">
        ...
        <div class="addresses">
            ...
            <div class="address-block">
                ...
                <?php if ($admin_email) echo '<p>' . esc_html($admin_email) . '</p>'; ?>
            </div>
        </div>
    ...
    <script>
        function downloadPDF() {
            ...
            var opt = {
                ...
                filename:     'Purchase-Order-<?php echo esc_js($order->post_title); ?>.pdf',
